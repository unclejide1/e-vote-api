package com.systemspecs.evoting.infrastructure.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.systemspecs.evoting.infrastructure.web.controllers"))
    ...
    private ApiInfo apiInfo(String version) {
        return new ApiInfoBuilder()
                ...
                .description("API services for conducting an election")
                .version(version)
                .build();
    }
//    @Bean
